...
/**
 * ECDH key exchange using nistp521 curve with SHA-512 (RFC 5656).
 *
 * @since 0.1.0
 */
public final class EcdhSha2Nistp521 implements KexAlgorithm {
    ...
    public byte[] localPublicValue() {
        ...
        return EcdhSha2Nistp256.encodeEcPoint(pub.getW(), 66);
    }
