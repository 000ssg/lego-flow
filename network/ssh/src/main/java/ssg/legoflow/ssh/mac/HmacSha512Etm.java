...
/**
 * HMAC-SHA2-512 with encrypt-then-MAC for SSH (hmac-sha2-512-etm@openssh.com).
 *
 * @since 1.0.0
 */
public final class HmacSha512Etm implements SshMac {

    private Mac mac;

    @Override public String name() { return "hmac-sha2-512-etm@openssh.com"; }
    @Override public int macLength() { return 64; }
    @Override public int keyLength() { return 64; }
    ...
    public void init(byte[] key) {
        try {
            ...
            throw new RuntimeException("Failed to initialize HMAC-SHA-512-ETM", e);
        }
    }
