...
public final class EcdsaSha2Nistp256 implements HostKeyAlgorithm {
    ...
    private static final String IDENTIFIER = "nistp256";

    @Override public String name() { return "ecdsa-sha2-nistp256"; }
    ...
    public byte[] sign(KeyPair keyPair, byte[] data) {
        try {
            ...
            return wrapSignature("ecdsa-sha2-nistp256", sigBytes);
        } catch (GeneralSecurityException e) {
    ...
    public byte[] encodePublicKey(KeyPair keyPair) {
        ...
        byte[] point = EcdhSha2Nistp256.encodeEcPoint(pub.getW(), 32);
