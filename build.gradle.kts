...
fun Project.setupInteropTestsModule() {
    ...
    tasks.withType<Test> {
        ...
        systemProperty("interop.xmpp.host", findProperty("interop.xmpp.host") ?: "localhost")
        systemProperty("interop.xmpp.port", findProperty("interop.xmpp.port") ?: "5222")
        systemProperty("interop.xmpp.domain", findProperty("interop.xmpp.domain") ?: "localhost")
        systemProperty("interop.xmpp.username", findProperty("interop.xmpp.username") ?: "test")
        systemProperty("interop.xmpp.password", findProperty("interop.xmpp.password") ?: "test")
        systemProperty("interop.amqp.host", findProperty("interop.amqp.host") ?: "localhost")
        systemProperty("interop.amqp.port", findProperty("interop.amqp.port") ?: "5672")
        systemProperty("interop.amqp.username", findProperty("interop.amqp.username") ?: "guest")
        systemProperty("interop.amqp.password", findProperty("interop.amqp.password") ?: "guest")
        systemProperty("interop.nats.host", findProperty("interop.nats.host") ?: "localhost")
        systemProperty("interop.nats.port", findProperty("interop.nats.port") ?: "4222")
        systemProperty("interop.stomp.host", findProperty("interop.stomp.host") ?: "localhost")
