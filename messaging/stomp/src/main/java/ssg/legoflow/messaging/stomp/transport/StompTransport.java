...
/**
 * Service Provider Interface for STOMP byte-level transport.
 *
 * <p>Implementations provide the actual mechanism for sending and receiving
 * raw bytes (e.g., TCP sockets, in-memory queues). The invariant STOMP core
 * uses this interface for all I/O, with {@link StompCodec} sitting on top
 * to handle frame encoding/decoding.
 *
 * @since 0.1.0
 */
