 ...
 * </ul>
 *
 * <p>The committed monolith v0 decoder dropped {@code errorMessage} and read
 * {@code sessionLifetimeMs} on v0 — both spec violations; this class implements the exact
 * per-version layouts.
 *
 * @since 0.1.0
 */
