...
/**
 * {@link KafkaTransport} implementation backed by a {@link DataChannel} in the
 * service pipeline.
 *
 ...
 *
 * <p>One instance per connection. The {@code SelectableChannelManager} selector thread
 * drives {@link #onRead} / {@link #onWrite} — this class never touches a socket directly.
 *
 * @since 0.1.0
 */
public final class PipelineKafkaTransport implements KafkaTransport {

    private static final Logger LOG = LoggerFactory.getLogger(PipelineKafkaTransport.class);
    ...
    public PipelineKafkaTransport(DataChannel channel) {
