...
- [ ] Negotiation/Auth sub-category (9 version sub-tasks) — v0 ✓ (`3f42231e`); v1 ✓ (`2f2d5ba8`); v2 ✓ (`bf084112` ApiVersions + this commit SaslAuthenticate — flexible encoding); 1 row remaining (ApiVersions v3 — flexible encoding + new fields)
