...
public final class SoapConstants {
    ...
    /** Error 401: Invalid Action - the action name is not recognized. @since 0.1.0 */
    public static final int ERROR_INVALID_ACTION = 401;

    /** Error 402: Invalid Args - incorrect number or type of arguments. @since 0.1.0 */
    public static final int ERROR_INVALID_ARGS = 402;

    /** Error 501: Action Failed - the action could not be executed. @since 0.1.0 */
    public static final int ERROR_ACTION_FAILED = 501;

    /** Error 600: Argument Value Invalid - argument value is out of range. @since 0.1.0 */
    public static final int ERROR_ARGUMENT_VALUE_INVALID = 600;

    /** Error 601: Argument Value Out of Range. @since 0.1.0 */
    public static final int ERROR_ARGUMENT_VALUE_OUT_OF_RANGE = 601;

    /** Error 602: Optional Action Not Implemented. @since 0.1.0 */
    public static final int ERROR_OPTIONAL_ACTION_NOT_IMPLEMENTED = 602;

    /** Error 603: Out of Memory. @since 0.1.0 */
    public static final int ERROR_OUT_OF_MEMORY = 603;

    /** Error 604: Human Intervention Required. @since 0.1.0 */
    public static final int ERROR_HUMAN_INTERVENTION_REQUIRED = 604;

    /** Error 605: String Argument Too Long. @since 0.1.0 */
