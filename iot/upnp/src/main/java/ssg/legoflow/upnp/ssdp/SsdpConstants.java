...
public final class SsdpConstants {
    ...
    // SSDP header names
    /** HOST header name. @since 1.0.0 */
    public static final String HEADER_HOST = "HOST";
    /** CACHE-CONTROL header name. @since 1.0.0 */
    public static final String HEADER_CACHE_CONTROL = "CACHE-CONTROL";
    /** LOCATION header name. @since 1.0.0 */
    ...
    /** SERVER header name. @since 1.0.0 */
    public static final String HEADER_SERVER = "SERVER";
    /** USN (unique service name) header name. @since 1.0.0 */
    public static final String HEADER_USN = "USN";
    /** MAN header name. @since 1.0.0 */
    public static final String HEADER_MAN = "MAN";
    /** MX (maximum wait) header name. @since 1.0.0 */
    public static final String HEADER_MX = "MX";
    /** ST (search target) header name. @since 1.0.0 */
    public static final String HEADER_ST = "ST";
    /** EXT header name (required in M-SEARCH responses). @since 1.0.0 */
    public static final String HEADER_EXT = "EXT";
    /** DATE header name. @since 1.0.0 */
